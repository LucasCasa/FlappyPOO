...
public class Types {
	...
	public static final Texture[] BACKGROUND = {new Texture("background_level1.png"),new Texture("background_level2.png"),new Texture("background_level3.png")};
	public static final Texture BACKGROUND_MODE3 = new Texture("v2.png");
	public static final Texture BACKGROUND_MODE2 = new Texture("bgMode2.jpg");
	public static final Texture[] GROUNDS = {new Texture("groundLevel1.png"),new Texture("groundLevel2.png"),new Texture("groundLevel3.png")};
	public static final Texture GROUND_MODE3 = new Texture("groundMode3.png");
	public static final Texture GROUND_MODE2 = new Texture("groundMode2.png");
